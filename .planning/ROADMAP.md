...
- [ ] 18-01-PLAN.md — /start pre-emption + ClientMenuCallbackResult union + showClientRootMenu + handleCallbackQuery business threading (CMENU-01, CMENU-05)
...
| 18. Client Menu | v1.4 | 0/4 | Not started | - |
